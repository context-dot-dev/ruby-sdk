...
```ruby
gem "brand.dev", git: "https://github.com/context-dot-dev/deprecated-brand-ruby-sdk"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/context-dot-dev/deprecated-brand-ruby-sdk' '<path-to-repo>'
```
