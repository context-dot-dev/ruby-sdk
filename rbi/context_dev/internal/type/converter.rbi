  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(ContextDev::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              ContextDev::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: ContextDev::Internal::Type::Converter::Input,
              value: T.anything,
              state: ContextDev::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
