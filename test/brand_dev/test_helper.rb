...
class BrandDev::Test::SingletonClient < BrandDev::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: BrandDev::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class BrandDev::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @brand_dev = BrandDev::Test::SingletonClient.instance
  end
