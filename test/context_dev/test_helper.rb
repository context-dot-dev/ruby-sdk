...
class ContextDev::Test::SingletonClient < ContextDev::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: ContextDev::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class ContextDev::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @context_dev = ContextDev::Test::SingletonClient.instance
  end
