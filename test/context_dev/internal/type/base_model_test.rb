...
class ContextDev::Test::PrimitiveModelTest < Minitest::Test
  A = ContextDev::Internal::Type::ArrayOf[-> { Integer }]
  H = ContextDev::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < ContextDev::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => ContextDev::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [ContextDev::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [ContextDev::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [ContextDev::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = ContextDev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        ContextDev::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [ContextDev::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [ContextDev::Internal::Type::Boolean, true] => true,
      [ContextDev::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => ContextDev::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        ContextDev::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = ContextDev::Internal::Type::Converter.new_coerce_state
      ContextDev::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        ContextDev::Internal::Type::Converter.dump(target, input, state: state)
...
class ContextDev::Test::EnumModelTest < Minitest::Test
  class E0
    include ContextDev::Internal::Type::Enum
...
class ContextDev::Test::CollectionModelTest < Minitest::Test
  A1 = ContextDev::Internal::Type::ArrayOf[-> { Integer }]
  H1 = ContextDev::Internal::Type::HashOf[Integer]

  A2 = ContextDev::Internal::Type::ArrayOf[H1]
  H2 = ContextDev::Internal::Type::HashOf[-> { A1 }]

  A3 = ContextDev::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = ContextDev::Internal::Type::HashOf[Integer, nil?: true]
...
class ContextDev::Test::BaseModelTest < Minitest::Test
  class M1 < ContextDev::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < ContextDev::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < ContextDev::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, ContextDev::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = ContextDev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = ContextDev::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(ContextDev::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue ContextDev::Errors::ConversionError => e
...
class ContextDev::Test::UnionTest < Minitest::Test
  class U0
    include ContextDev::Internal::Type::Union
  ...
  class M2 < ContextDev::Internal::Type::BaseModel
  ...
  class M4 < ContextDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, ContextDev::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < ContextDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, ContextDev::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class ContextDev::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include ContextDev::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [ContextDev::Internal::Type::Unknown, ContextDev::Internal::Type::Unknown] => true,
      [ContextDev::Internal::Type::Boolean, ContextDev::Internal::Type::Boolean] => true,
      [ContextDev::Internal::Type::Unknown, ContextDev::Internal::Type::Boolean] => false,
...
class ContextDev::Test::MetaInfoTest < Minitest::Test
  A1 = ContextDev::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = ContextDev::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
