  ...
  module Errors
    ...
    class APIStatusError < ContextDev::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          ContextDev::Errors::BadRequestError.new(**kwargs)
        in 401
          ContextDev::Errors::AuthenticationError.new(**kwargs)
        in 403
          ContextDev::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          ContextDev::Errors::NotFoundError.new(**kwargs)
        in 409
          ContextDev::Errors::ConflictError.new(**kwargs)
        in 422
          ContextDev::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          ContextDev::Errors::RateLimitError.new(**kwargs)
        in (500..)
          ContextDev::Errors::InternalServerError.new(**kwargs)
        else
          ContextDev::Errors::APIStatusError.new(**kwargs)
        end
      end
