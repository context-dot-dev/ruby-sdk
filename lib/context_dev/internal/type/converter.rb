    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { ContextDev::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { ContextDev::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            ContextDev::FilePart.new(value)
          in ContextDev::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in ContextDev::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [ContextDev::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: ContextDev::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in ContextDev::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in ContextDev::Internal::Type::Converter
              ...
              ContextDev::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(ContextDev::Internal::Type::Converter, T::Class[T.anything]) }
        end
