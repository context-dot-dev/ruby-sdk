    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          ContextDev::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        # @return [Object]
        def to_sorbet_type
          types = values.map { ContextDev::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
        ...
        def inspect(depth: 0)
          ...
          members = values.map { ContextDev::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
