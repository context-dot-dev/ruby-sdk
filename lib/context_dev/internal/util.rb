    ...
    module Util
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in ContextDev::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [ContextDev::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [ContextDev::Internal::Util::JSONL_CONTENT, Enumerable] unless ContextDev::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | ContextDev::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in ContextDev::Internal::Util::JSON_CONTENT
          ...
          in ContextDev::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [ContextDev::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in ContextDev::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
