...
module ContextDev
  module Models
    ...
    class BrandIdentifyFromTransactionParams < ContextDev::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, ContextDev::Models::BrandIdentifyFromTransactionParams::CountryGl, nil]
      optional :country_gl, enum: -> { ContextDev::BrandIdentifyFromTransactionParams::CountryGl }

      # @!attribute force_language
      #   Optional parameter to force the language of the retrieved brand data.
      #
      #   @return [Symbol, ContextDev::Models::BrandIdentifyFromTransactionParams::ForceLanguage, nil]
      optional :force_language, enum: -> { ContextDev::BrandIdentifyFromTransactionParams::ForceLanguage }
