...
module ContextDev
  module Models
    ...
    class BrandRetrieveByNameResponse < ContextDev::Internal::Type::BaseModel
      # @!attribute brand
      #   Detailed brand information
      #
      #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand, nil]
      optional :brand, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand }
      ...
      # @see ContextDev::Models::BrandRetrieveByNameResponse#brand
      class Brand < ContextDev::Internal::Type::BaseModel
        # @!attribute address
        #   Physical address of the brand
        #
        #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Address, nil]
        optional :address, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Address }

        # @!attribute backdrops
        #   An array of backdrop images for the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop>, nil]
        optional :backdrops,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop] }

        # @!attribute colors
        #   An array of brand colors
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Color>, nil]
        optional :colors,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Color] }
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries, nil]
        optional :industries, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries }
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Links, nil]
        optional :links, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Links }

        # @!attribute logos
        #   An array of logos associated with the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo>, nil]
        optional :logos,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo] }
        ...
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Social>, nil]
        optional :socials,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Social] }

        # @!attribute stock
        #   Stock market information for this brand (will be null if not a publicly traded
        #   company)
        #
        #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Stock, nil]
        optional :stock, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Stock }
        ...
        #   {ContextDev::Models::BrandRetrieveByNameResponse::Brand} for more details.
        #
        #   Detailed brand information
        #
        #   @param address [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Address] Physical address of the brand
        #
        #   @param backdrops [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop>] An array of backdrop images for the brand
        #
        #   @param colors [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Color>] An array of brand colors
        #
        ...
        #
        #   @param industries [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries] Industry classification information for the brand
        #
        #   @param is_nsfw [Boolean] Indicates whether the brand content is not safe for work (NSFW)
        #
        #   @param links [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Links] Important website links for the brand
        #
        #   @param logos [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo>] An array of logos associated with the brand
        #
        #   @param phone [String] Company phone number
        #
        #   @param slogan [String] The brand's slogan
        #
        #   @param socials [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Social>] An array of social media links for the brand
        #
        #   @param stock [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Stock] Stock market information for this brand (will be null if not a publicly traded c
        #
        #   @param title [String] The title or name of the brand

        # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand#address
        ...
        class Backdrop < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop::Color>, nil]
          optional :colors,
          ...
          #
          #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop::Resolution, nil]
          ...
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop::Color>] Array of colors in the backdrop image
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop::Resolution] Resolution of the backdrop image
          #
          ...
          # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Backdrop#resolution
        ...
        # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand#industries
        class Industries < ContextDev::Internal::Type::BaseModel
          # @!attribute eic
          #   Easy Industry Classification - array of industry and subindustry pairs
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic>, nil]
          optional :eic,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic] }

          # @!method initialize(eic: nil)
          #   Industry classification information for the brand
          #
          #   @param eic [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic>] Easy Industry Classification - array of industry and subindustry pairs

          class Eic < ContextDev::Internal::Type::BaseModel
            # @!attribute industry
            #   Industry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Industry]
            required :industry,
                     enum: -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Industry }

            # @!attribute subindustry
            #   Subindustry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Subindustry]
            required :subindustry,
                     enum: -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Subindustry }

            # @!method initialize(industry:, subindustry:)
            #   @param industry [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Industry] Industry classification enum
            #
            #   @param subindustry [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic::Subindustry] Subindustry classification enum

            # Industry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic#industry
            module Industry
            ...
            # Subindustry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Industries::Eic#subindustry
            module Subindustry
              extend ContextDev::Internal::Type::Enum
        ...
        # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand#links
        ...
        class Logo < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Color>, nil]
          optional :colors,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Color] }
          ...
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Mode, nil]
          optional :mode, enum: -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Mode }

          # @!attribute resolution
          #   Resolution of the logo image
          #
          #   @return [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Resolution, nil]
          optional :resolution, -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Resolution }

          # @!attribute type
          #   Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Type, nil]
          optional :type, enum: -> { ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo} for more details.
          #
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Color>] Array of colors in the logo
          #
          #   @param mode [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Mode] Indicates when this logo is best used: 'light' = best for light mode, 'dark' = b
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Resolution] Resolution of the logo image
          #
          #   @param type [Symbol, ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo::Type] Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          ...
          # has its own background
          #
          # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo#mode
          module Mode
            extend ContextDev::Internal::Type::Enum
          ...
          # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo#resolution
          class Resolution < ContextDev::Internal::Type::BaseModel
            # @!attribute aspect_ratio
            #   Aspect ratio of the image (width/height)
            #
          ...
          # Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          # @see ContextDev::Models::BrandRetrieveByNameResponse::Brand::Logo#type
          module Type
            extend ContextDev::Internal::Type::Enum
