...
module ContextDev
  module Models
    # @see ContextDev::Resources::Brand#retrieve_by_email
    class BrandRetrieveByEmailResponse < ContextDev::Internal::Type::BaseModel
      # @!attribute brand
      #   Detailed brand information
      #
      #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand, nil]
      optional :brand, -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand }
      ...
      #   @param brand [ContextDev::Models::BrandRetrieveByEmailResponse::Brand] Detailed brand information
      #
      #   @param code [Integer] HTTP status code
      #
      #   @param status [String] Status of the response, e.g., 'ok'

      # @see ContextDev::Models::BrandRetrieveByEmailResponse#brand
      class Brand < ContextDev::Internal::Type::BaseModel
        # @!attribute address
        #   Physical address of the brand
        #
        #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Address, nil]
        optional :address, -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Address }

        # @!attribute backdrops
        #   An array of backdrop images for the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop>, nil]
        optional :backdrops,
        ...
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Color>, nil]
        optional :colors,
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries, nil]
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Links, nil]
        optional :links, -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Links }

        # @!attribute logos
        #   An array of logos associated with the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo>, nil]
        optional :logos,
        ...
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Social>, nil]
        optional :socials,
        ...
        #   company)
        #
        #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Stock, nil]
        ...
        #   Detailed brand information
        #
        #   @param address [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Address] Physical address of the brand
        #
        #   @param backdrops [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop>] An array of backdrop images for the brand
        #
        #   @param colors [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Color>] An array of brand colors
        #
        ...
        #
        #   @param industries [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries] Industry classification information for the brand
        #
        #   @param is_nsfw [Boolean] Indicates whether the brand content is not safe for work (NSFW)
        #
        #   @param links [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Links] Important website links for the brand
        #
        #   @param logos [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo>] An array of logos associated with the brand
        #
        ...
        #
        #   @param stock [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Stock] Stock market information for this brand (will be null if not a publicly traded c
        #
        #   @param title [String] The title or name of the brand

        # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand#address
        ...
        class Backdrop < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Color>, nil]
          optional :colors,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Color] }

          # @!attribute resolution
          #   Resolution of the backdrop image
          #
          #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Resolution, nil]
          optional :resolution, -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Resolution }
          ...
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Color>] Array of colors in the backdrop image
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop::Resolution] Resolution of the backdrop image
          #
          ...
          # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Backdrop#resolution
        ...
        # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand#industries
        class Industries < ContextDev::Internal::Type::BaseModel
          # @!attribute eic
          #   Easy Industry Classification - array of industry and subindustry pairs
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic>, nil]
          optional :eic,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic] }

          # @!method initialize(eic: nil)
          #   Industry classification information for the brand
          #
          #   @param eic [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic>] Easy Industry Classification - array of industry and subindustry pairs

          class Eic < ContextDev::Internal::Type::BaseModel
            # @!attribute industry
            #   Industry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Industry]
            required :industry,
                     enum: -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Industry }

            # @!attribute subindustry
            #   Subindustry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Subindustry]
            required :subindustry,
                     enum: -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Subindustry }

            # @!method initialize(industry:, subindustry:)
            #   @param industry [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Industry] Industry classification enum
            #
            #   @param subindustry [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic::Subindustry] Subindustry classification enum

            # Industry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic#industry
            module Industry
            ...
            # Subindustry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Industries::Eic#subindustry
            module Subindustry
              extend ContextDev::Internal::Type::Enum
        ...
        # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand#links
        ...
        class Logo < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Color>, nil]
          optional :colors,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Color] }
          ...
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Mode, nil]
          optional :mode, enum: -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Mode }

          # @!attribute resolution
          #   Resolution of the logo image
          #
          #   @return [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Resolution, nil]
          optional :resolution, -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Resolution }

          # @!attribute type
          #   Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Type, nil]
          optional :type, enum: -> { ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo} for more
          #   details.
          #
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Color>] Array of colors in the logo
          #
          #   @param mode [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Mode] Indicates when this logo is best used: 'light' = best for light mode, 'dark' = b
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Resolution] Resolution of the logo image
          #
          #   @param type [Symbol, ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo::Type] Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          ...
          # has its own background
          #
          # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo#mode
          module Mode
            extend ContextDev::Internal::Type::Enum
          ...
          # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo#resolution
          class Resolution < ContextDev::Internal::Type::BaseModel
            # @!attribute aspect_ratio
            #   Aspect ratio of the image (width/height)
            #
          ...
          # Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          # @see ContextDev::Models::BrandRetrieveByEmailResponse::Brand::Logo#type
          module Type
            extend ContextDev::Internal::Type::Enum
