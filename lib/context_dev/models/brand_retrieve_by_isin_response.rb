...
module ContextDev
  module Models
    # @see ContextDev::Resources::Brand#retrieve_by_isin
    class BrandRetrieveByIsinResponse < ContextDev::Internal::Type::BaseModel
      # @!attribute brand
      #   Detailed brand information
      #
      #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand, nil]
      optional :brand, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand }
      ...
      #   @param brand [ContextDev::Models::BrandRetrieveByIsinResponse::Brand] Detailed brand information
      #
      #   @param code [Integer] HTTP status code
      #
      #   @param status [String] Status of the response, e.g., 'ok'

      # @see ContextDev::Models::BrandRetrieveByIsinResponse#brand
      class Brand < ContextDev::Internal::Type::BaseModel
        # @!attribute address
        #   Physical address of the brand
        #
        #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Address, nil]
        optional :address, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Address }

        # @!attribute backdrops
        #   An array of backdrop images for the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop>, nil]
        optional :backdrops,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop] }

        # @!attribute colors
        #   An array of brand colors
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Color>, nil]
        optional :colors,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Color] }
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries, nil]
        optional :industries, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries }
        ...
        #
        #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Links, nil]
        optional :links, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Links }

        # @!attribute logos
        #   An array of logos associated with the brand
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo>, nil]
        optional :logos,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo] }
        ...
        #
        #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Social>, nil]
        optional :socials,
                 -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Social] }

        # @!attribute stock
        #   Stock market information for this brand (will be null if not a publicly traded
        #   company)
        #
        #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Stock, nil]
        optional :stock, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Stock }
        ...
        #   Detailed brand information
        #
        #   @param address [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Address] Physical address of the brand
        #
        #   @param backdrops [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop>] An array of backdrop images for the brand
        #
        #   @param colors [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Color>] An array of brand colors
        #
        ...
        #
        #   @param industries [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries] Industry classification information for the brand
        #
        #   @param is_nsfw [Boolean] Indicates whether the brand content is not safe for work (NSFW)
        #
        #   @param links [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Links] Important website links for the brand
        #
        #   @param logos [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo>] An array of logos associated with the brand
        #
        ...
        #
        #   @param stock [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Stock] Stock market information for this brand (will be null if not a publicly traded c
        #
        #   @param title [String] The title or name of the brand

        # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand#address
        ...
        class Backdrop < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color>, nil]
          optional :colors,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color] }

          # @!attribute resolution
          #   Resolution of the backdrop image
          #
          #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution, nil]
          optional :resolution, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution }
          ...
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color>] Array of colors in the backdrop image
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution] Resolution of the backdrop image
          #
          ...
          # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop#resolution
        ...
        # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand#industries
        class Industries < ContextDev::Internal::Type::BaseModel
          # @!attribute eic
          #   Easy Industry Classification - array of industry and subindustry pairs
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic>, nil]
          optional :eic,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic] }

          # @!method initialize(eic: nil)
          #   Industry classification information for the brand
          #
          #   @param eic [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic>] Easy Industry Classification - array of industry and subindustry pairs

          class Eic < ContextDev::Internal::Type::BaseModel
            # @!attribute industry
            #   Industry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry]
            required :industry,
                     enum: -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry }

            # @!attribute subindustry
            #   Subindustry classification enum
            #
            #   @return [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry]
            required :subindustry,
                     enum: -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry }

            # @!method initialize(industry:, subindustry:)
            #   @param industry [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry] Industry classification enum
            #
            #   @param subindustry [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry] Subindustry classification enum

            # Industry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic#industry
            module Industry
            ...
            # Subindustry classification enum
            #
            # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic#subindustry
            module Subindustry
              extend ContextDev::Internal::Type::Enum
        ...
        # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand#links
        ...
        class Logo < ContextDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color>, nil]
          optional :colors,
                   -> { ContextDev::Internal::Type::ArrayOf[ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color] }
          ...
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode, nil]
          optional :mode, enum: -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode }

          # @!attribute resolution
          #   Resolution of the logo image
          #
          #   @return [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution, nil]
          optional :resolution, -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution }

          # @!attribute type
          #   Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          #   @return [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type, nil]
          optional :type, enum: -> { ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo} for more details.
          #
          #   @param colors [Array<ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color>] Array of colors in the logo
          #
          #   @param mode [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode] Indicates when this logo is best used: 'light' = best for light mode, 'dark' = b
          #
          #   @param resolution [ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution] Resolution of the logo image
          #
          #   @param type [Symbol, ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type] Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          ...
          # has its own background
          #
          # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#mode
          module Mode
            extend ContextDev::Internal::Type::Enum
          ...
          # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#resolution
          class Resolution < ContextDev::Internal::Type::BaseModel
            # @!attribute aspect_ratio
            #   Aspect ratio of the image (width/height)
            #
          ...
          # Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          # @see ContextDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#type
          module Type
            extend ContextDev::Internal::Type::Enum
